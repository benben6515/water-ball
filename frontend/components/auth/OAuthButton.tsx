 ...
 * Redirects to the backend OAuth authorization endpoint when clicked.
 *
 * Example usage:
 * <OAuthButton provider="google" label="使用 Google 登入" />
 * <OAuthButton provider="facebook" label="使用 Facebook 登入" />
 */
